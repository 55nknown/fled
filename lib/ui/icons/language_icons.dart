const languageIcons = [
  {
    "icon": {"name": 'git'},
    "ids": ['git', 'git-commit', 'git-rebase', 'ignore']
  },
  {
    "icon": {"name": 'c'},
    "ids": ['c', 'objective-c', 'objective-cpp']
  },
  {
    "icon": {"name": 'yaml'},
    "ids": ['yaml']
  ...
  {
    "icon": {"name": 'php_elephant'},
    "ids": []
  },
  {
    "icon": {"name": 'php_elephant_pink'},
    "ids": []
  },
  {
    "icon": {"name": 'hack'},
  ...
  {
    "icon": {"name": 'nodejs_alt'},
    "ids": []
  },
  {
    "icon": {"name": 'django'},
    "ids": ['django-html', 'django-txt']
  },
  {
    "icon": {"name": 'html'},
    "ids": ['html']
  ...
  {
    "icon": {"name": 'tex'},
    "ids": ['tex', 'doctex', 'latex', 'latex-expl3']
  },
  {
  ...
  {
    "icon": {"name": 'python-misc'},
    "ids": ['pip-requirements']
  },
  {
    "icon": {"name": 'vue'},
    "ids": ['vue', 'vue-postcss', 'vue-html']
  },
  {
    "icon": {"name": 'lua'},
    "ids": ['lua']
